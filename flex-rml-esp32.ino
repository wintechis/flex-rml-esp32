...
std::string rml_rule = R"a(@prefix rr: <http://www.w3.org/ns/r2rml#> .
...
std::string csv_data_1 = R"a(ID,DateTime,Temperature,Humidity,EventID
...
std::string csv_data_2 = R"a(DateTime,LightIntensity,AirQuality
...
std::string csv_data_3 = R"a(EventID,EventName
1,Event_A
2,Event_B
3,Event_C
4,Event_D
...
void setup() {
  ...
  input_data["csv_data_1"] = csv_data_1;
  input_data["csv_data_2"] = csv_data_2;
  input_data["csv_data_3"] = csv_data_3;

  unsigned long start_time = millis();
  std::unordered_set<NQuad> generated_quads = map_data(rml_rule, input_data);
  ...
  /*
  Serial.println("Resulting Graph:");
  for (const NQuad& quad : generated_quads) {
    Serial.print(quad.subject.c_str());
    Serial.print(" ");
    Serial.print(quad.predicate.c_str());
    Serial.print(" ");
    Serial.print(quad.object.c_str());
    Serial.print(" ");
    Serial.print(quad.graph.c_str());
    Serial.println(" .");
  } */

  Serial.print("Generated ");
  Serial.print(generated_quads.size());
  Serial.println(" N-Quads");



  Serial.print("Mapping took: ");
